...
public class HashedDictionaryOpenAddressingPerfectInstrumented<K,V> implements DictionaryInterface<K,V>
{
    ...
    private boolean isOddPrime(int t)  // Not the most efficient method, but it will serve
    {
     ...
     public Random getHashGenerator(K key){
        Random rand = new Random(key.toString().hashCode());
        return rand;
     }
    ...
    public V getValue(K key)
    {
        ...
        V result = null;
        int index = locate(getHashGenerator(key), key);
       ...
       int index = rand.nextInt(hashTable.length);
        ...
        while ( !found && (hashTable[index] != null) )
        {
            ...
            if ( hashTable[index].isIn() &&
                ...
                index = rand.nextInt(hashTable.length);
    ...
    public V add(K key, V value) {
        ...
        if ((key == null) || (value == null)) {
            ...
            int index = probe(getHashGenerator(key), key); // Check for and resolve collision
