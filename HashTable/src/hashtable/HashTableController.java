...
public class HashTableController implements Initializable {
    ...
    public void HashPerformance() {
        ...
        this.console.appendText("Successful Searches: " + successLinearProbes  + "\n\n");
        this.console.appendText("Failure Searches:  " + failureLinearProbes  + "\n\n");
        this.console.appendText("       Average success probes made: " + successLinearProbes / (float) (trials * insertCount) + "\n\n");
        this.console.appendText("       Average failure probes made: " + failureLinearProbes / (float) (trials * insertCount) + "\n\n");
        ...
        // ADD CODE HERE TO REPORT THE RESULTS FOR THE SUCCESS AND FAILURE SEARCHES
        this.console.appendText("Successful Searches: " + successDoubleProbes + "\n\n");
        this.console.appendText("Failure Searches:  " + failureDoubleProbes + "\n\n");
        this.console.appendText("       Average success probes made: " + successDoubleProbes / (float) (trials * insertCount) + "\n\n");
        this.console.appendText("       Average failure probes made: " + failureDoubleProbes / (float) (trials * insertCount) + "\n\n");
        ...
        this.console.appendText("Successful Searches: " + successPerfectProbes + "\n\n");
        this.console.appendText("Failure Searches:  " + failurePerfectProbes + "\n\n");
        this.console.appendText("       Average success probes made: " + successPerfectProbes / (float) (trials * insertCount) + "\n\n");
        this.console.appendText("       Average failure probes made: " + failurePerfectProbes / (float) (trials * insertCount) + "\n\n");
...
// ADD CODE HERE TO REPORT THE RESULTS FOR THE SUCCESS AND FAILURE SEARCHES
    ...
    private String[] generateRandomData(int size) {
        ...
        for(int x = 0; x<size; x++){
            ...
            String word = firstSyl[rand.nextInt(15)] + secondSyl[rand.nextInt(15)] + thirdSyl[rand.nextInt(15)];
           // System.out.println("LOOl fml: " + word + ": " + x);
            if (!(checkTable.contains(word))){ 
                checkTable.add(word,word);
                result[x] = word;
                //System.out.println("ADD TO DICTIONARY: " + word + ": " + x);
            } else{
                x--;
            }
        }
